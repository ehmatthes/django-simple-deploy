...
You can also see the [contributing](docs/contributing.md) page. Here you'll see how to demo the project, how to run [unit](docs/unit_tests.md) and [integration tests](docs/integration_tests.md), and how to set up a development environment for the project.
